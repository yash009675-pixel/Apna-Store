...
function renderProduct(product,variants=[],images=[]){
 ...
 if(!available.length)return showError("This product is currently out of stock.");
 ...
 refreshOptions();wishlistState().then(v=>{document.getElementById("wishlistBtn").textContent=v?"♥ Saved":"♡ Wishlist"});renderRelated(product);
}
