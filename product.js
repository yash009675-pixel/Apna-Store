...
function renderProduct(product,variants=[]){
 ...
 if(product.image){const mi=document.getElementById("mainProductImage");mi.style.backgroundImage="url('"+product.image+"')";mi.style.backgroundSize="cover";mi.style.backgroundPosition="center";mi.innerHTML="";}
...
async function loadProduct(){
 ...
 try{
  ...
  renderProduct({...data,category:categoryMap.get(data.category_id)||"Apna Store",image},vr.data||[]);
