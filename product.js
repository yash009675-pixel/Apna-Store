...
function renderProduct(product,variants=[]){
 ...
 function refreshOptions(){findVariant();document.getElementById("add").disabled=!variantId;document.getElementById("add").textContent=variantId?"Add to bag →":"Select available size & color"}
